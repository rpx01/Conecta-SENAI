"""create treinamento tables

Revision ID: 00fc2292023f
Revises: 
Create Date: 2025-07-22 01:55:09.485796
...
def upgrade() -> None:
    ...
    sa.Column('possui_treinamento_pratico', sa.Boolean(), nullable=True),
