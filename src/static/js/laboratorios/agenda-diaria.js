        ...
        agendaContainer.innerHTML = ['Manhã', 'Tarde', 'Noite'].map(turno => {
            ...
            <div class="card turno-card">
                    ...
                    ${dadosTurno.agendamentos.length > 0 ? `<h6><i class="bi bi-calendar-x-fill"></i> Horários Ocupados</h6>` + dadosTurno.agendamentos.map(ag => {
                        ...
                        <div class="agendamento-item" data-id="${ag.id}">
                            ...
                            ${podeGerenciar ? `<div class="agendamento-acoes btn-group">
                                <a href="/laboratorios/agendamento_laboratorio.html?id=${ag.id}" class="btn btn-sm btn-outline-primary" title="Editar"><i class="bi bi-pencil"></i></a>
                ...
                <div class="card-footer text-end">
                    <a href="/laboratorios/agendamento_laboratorio.html?lab_id=${labSelecionadoId}&data=${dataFormatada}&turno=${turno}" class="btn btn-primary btn-sm"><i class="bi bi-plus"></i> Novo Agendamento</a>
                </div>
            </div>`;
        }).join('');
    };
