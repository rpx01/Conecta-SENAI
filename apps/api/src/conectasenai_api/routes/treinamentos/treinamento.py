...
from conectasenai_api.models import (
    db,
    Treinamento,
    TurmaTreinamento,
...
from conectasenai_api.schemas.treinamento import (
...
from conectasenai_api.auth import login_required, admin_required
...
LOGO_PATH = STATIC_DIR / "img" / "senai-logo.png"
