...
from conectasenai_api.models.laboratorio_turma import Turma
from conectasenai_api.routes.user import verificar_autenticacao, verificar_admin
from conectasenai_api.models.treinamento import TurmaTreinamento, InscricaoTreinamento
from conectasenai_api.services.email_service import (
    enviar_convocacao,
    notificar_atualizacao_turma,
    EmailService,
)
from conectasenai_api.auth import admin_required
