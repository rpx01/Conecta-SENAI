...
import sentry_sdk
from conectasenai_api.redis_client import init_redis
from conectasenai_api.config import DevConfig, ProdConfig, TestConfig
from conectasenai_api.repositories.user_repository import UserRepository
from conectasenai_api.logging_conf import setup_logging
from conectasenai_api.middlewares.request_id import request_id_bp
from conectasenai_api.telemetry import instrument
from conectasenai_api.extensions import db, migrate, jwt, limiter
...
from conectasenai_api.routes.notificacao import notificacao_bp
from conectasenai_api.routes.ocupacao import ocupacao_bp, sala_bp, instrutor_bp
from conectasenai_api.routes.user import user_bp
from conectasenai_api.routes.rateio import rateio_bp
from conectasenai_api.routes.treinamentos import treinamento_bp, turma_bp
...
from conectasenai_api.routes.planejamento import basedados_bp, planejamento_bp
from conectasenai_api.routes.horario import horario_bp
from conectasenai_api.routes.inscricoes_treinamento import bp as inscricoes_treinamento_bp
from conectasenai_api.blueprints.auth_reset import auth_reset_bp
from conectasenai_api.blueprints.auth import auth_bp
from conectasenai_api.scheduler import start_scheduler
...
def create_default_recursos(app):
    ...
    from conectasenai_api.models.recurso import Recurso
